...
return [
	...
	"for_your_style" => "For your style",
	"express_your_unique_style" => "Express your unique style",
	...
	"Please fill brand_id fields" => "Please fill brand id fields",
	...
	"category'nvOpzp; AND 1=1 OR (<'>iKO))," => "Category nvOpzp  AND 1=1 OR (   iKO)) ",
	"core" => "Core",
	"Junction" => "Junction",
	"brand'" => "Brand ",
	"Shape" => "Shape",
	...
	"Upload_Product_List" => "Upload Product List",
	"Choose_file" => "Choose file",
	"Process_&_Checkout" => "Process & Checkout",
	"Bulk_Order_Preview" => "Bulk Order Preview",
	"Items_Matched" => "Items Matched",
	"Physical" => "Physical",
	"Add_to_Cart_&_Checkout" => "Add to Cart & Checkout",
	"Max_stock_reached" => "Max stock reached",
	"Quantity_cannot_exceed_stock" => "Quantity cannot exceed stock",
