<div class="__inline-9 rtl">
    <div class="text-center pb-4">
        <div class="max-w-1160px mx-auto footer-slider-container">
            <div class="container">
                <div class="footer-slider owl-theme owl-carousel" data-item="{{ Route::has('frontend.blog.index') && getWebConfig(name: 'blog_feature_active_status') ? 4 : 3 }}">
                    ...
                    <div class="footer-slide-item">
                        <div>
                            <a href="{{ route('frontend.blog.index') }}">
                                <div class="text-center text-primary">
                                    <img class="object-contain svg" width="36" height="36" src="{{ theme_asset(path: "public/assets/front-end/img/icons/blog-icon.svg")}}"
                                        alt="">
                                </div>
                                <div class="text-center">
                                    <p class="m-0 mt-2">
    ...
    <footer class="page-footer font-small mdb-color rtl" style="padding-left: 2%;padding-right: 2%; background-color: #f7f7f7;">
        <div class="pt-4 custom-light-primary-color-20" style="border-radius: 25px;background-color: black;padding: 12px;">
        ...
        <div class="bg-white-overlay-50 " style="background-color: #000; margin-top: 20px; border-radius: 25px;">
            <div class="container">
