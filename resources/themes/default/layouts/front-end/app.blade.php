...
<head>
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/product-card-style-4.css') }}">
    ...
    <style>
        :root {
            ...
            /* Define CSS variables for template colors */
            --template-primary-color: {{ $web_config['primary_color'] }};
            --template-secondary-color: {{ $web_config['secondary_color'] }};
            --template-primary-color-alpha: {{ $web_config['primary_color'] }}1A; /* Example for primary with alpha */
        }
...
<body class="toolbar-enabled" style="background-color: #f7f7f7;">
