            ...
            <div class="row {{Session::get('direction') === "rtl" ? '__dir-rtl' : ''}}">
                <div class="col-lg-12">
                                                ...
                                                @foreach ($product->color_images_full_url as $key => $photo)
                                                    @if($photo['color'] != null)
                                                        <div
                                                            ...
                                                            <img class="variant-img cz-image-zoom img-responsive w-100"
                    ...
                    <div class="col-lg-1"></div>
                        <div class="col-lg-5 col-md-8 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100 product-cart-option-container">
                                <h2 class="mb-2 __inline-24" style="font-size: 30px;">{{ $product->name }}</h2>
...
@push('script')
    ...
    (function (){
        document.addEventListener('DOMContentLoaded', function () {
            ...
            try {
                productVariations = {!! $product->variation ? $product->variation : '[]' !!};
            } catch (e) {
                productVariations = [];
            }
            ...
            function getSelectedVariationValue(form) {
                if (!form) return '';
            ...
            function findMatchingVariation(selectedValue) {
                if (!selectedValue || productVariations.length === 0) return null;
                ...
                for (const v of productVariations) {
                    ...
                    if (normalize(v.type) === normalizedSelected) {
                        return v;
                    }
                }
            ...
            function showVariationImage() {
                ...
                const selectedValue = getSelectedVariationValue(form);
